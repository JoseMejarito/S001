...
// Get total number of users and listings
        ...
        <div class="col-md-4">
            <div class="card">
                <div class="card-body">
                    ...
                    <p class="card-text"><?php echo $totalListings; ?></p>
                </div>
            </div>
        </div>
        <div class="col-md-4">
            <div class="card">
                <div class="card-body">
                    ...
                    <p class="card-text">PHP <?php echo $totalRevenue; ?></p>
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="col-md-6">
            <div class="card">
                <div class="card-body">
                    ...
                    <p class="card-text">PHP <?php echo $totalListings > 0 ? round($totalRevenue / $totalListings, 2) : 0; ?></p>
                </div>
            </div>
        </div>
        <div class="col-md-6">
            <div class="card">
                <div class="card-body">
                    ...
                    <p class="card-text"><?php echo $totalUsers > 0 ? round($totalListings / $totalUsers, 2) : 0; ?></p>
                </div>
            </div>
        </div>
    </div>
...
<script>
    ...
    function fetchAnalyticsData() {
        ...
        var analyticsData = {
            ...
            datasets: [{
                ...
                data: [12, 23, 15, 19, <?php echo $totalListings; ?>],
    ...
    function renderAnalyticsChart(data) {
        ...
        var chart = new Chart(ctx, {
            ...
            data: data,
            options: {
                indexAxis: 'x', // Display data on the y-axis
                aspectRatio: 5, // Set aspect ratio for smaller size
                responsive: true,
